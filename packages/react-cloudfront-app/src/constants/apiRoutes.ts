...
export const apiRoutes = {
  ...
  getCartByUserId: (userId: string) => `${HTTP_CART_SERVICE_API_GATEWAY}/api/carts?userId=${userId}`,
  checkout: () => `${HTTP_CART_SERVICE_API_GATEWAY}/api/carts/checkout`,
  ordersByUserId: (userId: string) => `${HTTP_CART_SERVICE_API_GATEWAY}/api/orders/?userId=${userId}`,
};
// api/profile/:userId/carts
